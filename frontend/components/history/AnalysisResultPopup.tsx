...
const sections = [
  ...
  { id: "visualisations", label: "Charts" },
  { id: "ml", label: "ML Lab" },
] as const;
...
function SectionFrame({ id, title, children }: { id: string; title: string; children: ReactNode }) {
  return (
    ...
    >
      ...
      >
        <div className="border-b border-white/10 px-6 py-5">
          ...
          {report && ready ? (
            <div className="mt-4 overflow-x-auto overflow-y-visible pb-2 pt-1">
