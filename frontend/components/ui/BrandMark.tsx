...
export default function BrandMark({
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      >
        <div className="absolute inset-[5px] rounded-[14px] border border-white/10 bg-[linear-gradient(155deg,_rgba(122,214,255,0.22),_rgba(255,176,121,0.08)_55%,_rgba(255,255,255,0.06))]" />
        <div className="absolute left-2.5 top-2.5 h-1.5 w-1.5 rounded-full bg-[#7ad6ff] shadow-[0_0_18px_rgba(122,214,255,0.65)]" />
        <div className="absolute bottom-2.5 right-2.5 h-2 w-2 rounded-full bg-[#ffb079] shadow-[0_0_20px_rgba(255,176,121,0.55)]" />
        <div className="absolute inset-x-2.5 bottom-3 flex items-end gap-1.5">
          ...
          <span className="h-8 flex-1 rounded-full bg-[#ffb079]/80" />
        </div>
      </div>
